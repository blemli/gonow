...
echo "dtparam=poe_fan_temp0=50000" | sudo tee -a /boot/config.txt
echo "dtparam=poe_fan_temp1=60000" | sudo tee -a /boot/config.txt
echo "dtparam=poe_fan_temp2=70000" | sudo tee -a /boot/config.txt
echo "dtparam=poe_fan_temp3=80000" | sudo tee -a /boot/config.txt
